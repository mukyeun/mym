...
const Symptom = require('../models/Symptom');  // 경로 수정
const auth = require('../middleware/auth');
const logger = require('../../config/logger');  // 경로 수정
const { validate } = require('../middleware/validators/commonValidator');  // 경로 수정
const { symptomValidationRules } = require('../middleware/validators/symptomValidator');  // 유효성 검사 규칙 분리
